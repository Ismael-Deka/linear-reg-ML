...
while(cost >= 1000):
    ...
    b_p =b
    y_pred_p = y_pred
    grad_one = gradient(X_1_train, y_train, y_pred)
    grad_two = gradient_deriv(X_1_train, X_2_train, y_train, y_pred)
    grad_three = gradient_deriv(X_1_train, X_3_train, y_train, y_pred)
    grad_4 = gradient_deriv(X_1_train, X_4_train, y_train, y_pred)
    grad_5 = gradient_deriv(X_1_train, X_5_train, y_train, y_pred)
